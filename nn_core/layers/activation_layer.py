...
class Activation:
    ...
    def f(self, x: np.ndarray) -> np.ndarray:
        ...
        Returns:
            np.ndarray: Output after applying the activation function, same shape as input.
        """
        pass
    ...
    def d(self, x: np.ndarray) -> np.ndarray:
        ...
        Returns:
            np.ndarray: Derivative of the activation function, same shape as input.
        """
        pass
...
class ActivationLayer(Layer):
    ...
    def forward(self, x: np.ndarray, training: bool) -> np.ndarray:
        ...
        Args:
            x (np.ndarray): Input data. Shape: (batch_size, features).
            store_input (bool): Whether to store input/output for backward.

        Returns:
            np.ndarray: Output of activation function, same shape as input.
        """
    ...
    def backward(self, grad: np.ndarray, lr: float) -> np.ndarray:
        ...
        Args:
            grad (np.ndarray): Gradient from the next layer. Shape: (batch_size, features).
            learning_rate (float): Learning rate (not used in activation layers but kept for interface consistency).

        Returns:
            np.ndarray: Gradient to pass to the previous layer. Shape: (batch_size, features).
        """
